...
def webhook_pooling(
        ...
        startup_message: str = 'Bot has been started',
        shutdown_message: str = 'Bot has been stoped'
):
    bot = Bot(token=token)
    ...
    webhook_path = f'{input("Введите ngrok url ")}/{token}'  # this is the path for your TOKEN_API 'URI'
